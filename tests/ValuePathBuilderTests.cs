...
namespace NuExt.System.Tests
{
    ...
    public class ValuePathBuilderTests
    {
        ...
        public void Test2()
        {
            var p = new Path("initial/path".AsSpan()) { DirectorySeparatorChar = '/' };
        ...
        public void Test4()
        {
            ...
            Assert.That(new string(arr, 0, numWritten), Is.EqualTo("initial/path/additional/path"));
        }
        ...
        {
            var p = new Path(@"C:\Users\Test".AsSpan());
        ...
        public void TestGetDirectoryName_RootPath()
        {
            ...
            var p = new Path(path.AsSpan()) { DirectorySeparatorChar = '/' };
        ...
        {
            var path = new Path("directory/oldname.txt".AsSpan());
        ...
        {
            var path = new Path("directory/oldname".AsSpan());
        ...
        {
            var path = new Path("directory/".AsSpan());
        ...
        {
            var path = new Path("directory/samefile.txt".AsSpan());
        ...
        {
            var path = new Path("directory/old name with spaces.txt".AsSpan());
        ...
        public void TestGetPathSegments_UnixRootPath()
        {
            ...
            Assert.That(segments[0].ToString(), Is.EqualTo("/"));
        }
        ...
        {
            var p = new Path(path1.AsSpan()) { DirectorySeparatorChar = directorySeparatorChar };
        ...
        {
            var p = new Path(relativePath.AsSpan()) { DirectorySeparatorChar = directorySeparatorChar };
        ...
        {
            var p = new Path(relativeTo.AsSpan()) { DirectorySeparatorChar = directorySeparatorChar };
        ...
        {
            var p = new Path(path.AsSpan()) { DirectorySeparatorChar = directorySeparatorChar };
